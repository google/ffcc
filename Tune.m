...
if overwrite_parameters
  ...
  system(['g4 edit ', filename]); % Ensure the file is editable in the client.
else
...
% Disable training output so that tuning is easier to parse.
params.DEBUG.DISPLAY_LBFGS = false;
