...
[~, m] = GehlerShiDeepESHyperparams;
v = extract_errors(m.rgb_err);
results.metrics.fCCC_deepES = v(1:5)';
results.testtimes.fCCC_deepES = m.min_feature_time + m.min_filter_time;
results.traintimes.fCCC_deepES = mean(m.train_times);
...
results.method_names.fCCC_deepES = ...
  '\texttt{P}) FFCC - full, 2 channels, +metadata +semantics\cite{Wang2014}';
...
system('g4 edit ../docs/gehler_shi_table.tex');
fid = fopen('../docs/gehler_shi_table.tex', 'w');
