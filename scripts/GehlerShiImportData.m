...
% dataset into the format specified by each project. This should not be run by
% a user of this codebase unless they are creating a new project which needs to
% be trained using the Gehler-Shi dataset, or if they have changed the project
% parameters for a project which uses the Gehler-Shi dataset in a way that
% affects the input stats for the project. Consider contacting barron@ before
% running or changing this script.
